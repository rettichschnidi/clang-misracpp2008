...
int a; // expected-error {{Previous occurence of identifier 'a'}}
...
int b; // expected-error {{Previous occurence of identifier 'b'}}
extern "C" {
  void fnB() {
...
int c; // expected-error {{Previous occurence of identifier 'c'}}
void fnB2() {
...
int d; // expected-error {{Previous occurence of identifier 'd'}}
int e; // expected-error {{Previous occurence of identifier 'e'}}
class MyClass {
  ...
  void someMethod(); // expected-error {{Previous occurence of identifier 'someMethod'}}
  void operator++() {}
  class MyInnerClass {
