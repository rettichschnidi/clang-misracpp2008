...
#include <cstdlib>
void useAtof() {
    float f = atof("3.3"); // expected-error {{The library functions atof, atoi and atol from library <cstdlib> shall not be used.}}
}

void useAtoi() {
    int i = atoi("123"); // expected-error {{The library functions atof, atoi and atol from library <cstdlib> shall not be used.}}
}
