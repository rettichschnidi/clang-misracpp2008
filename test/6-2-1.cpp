// RUN: %clang -fsyntax-only -std=c++11 -ferror-limit=0 -Wno-parentheses -Xclang -verify -Xclang -load -Xclang %llvmshlibdir/misracpp2008%pluginext -Xclang -plugin -Xclang misra.cpp.2008 -Xclang -plugin-arg-misra.cpp.2008 -Xclang 6-2-1 %s
